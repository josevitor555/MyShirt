...
function updateTotal() {
    ...
    document.getElementsByClassName("total-price")[0].innerHTML = formatBRL(total);
...
function loadCartItems() {
    ...
    if (cartTotal) {
        document.getElementsByClassName('total-price')[0].innerText = formatBRL(parseFloat(cartTotal));
    }
